...
public class otpAuthantication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otp_authantication);
        ...
        mchangenumber.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(otpAuthantication.this,MainActivity.class);
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful())
                {
                    ...
                    Intent intent=new Intent(otpAuthantication.this,setProfile.class);
                    startActivity(intent);
                    finish();
                }
                else
